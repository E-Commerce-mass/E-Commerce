...
const Sports=(props)=>{
    ...
    data.map((e)=>{
    if(JSON.stringify(e.categories).includes("sports")){
       arr.push(e)
    ...
    return (
        <div>
 <div>
         <h1 style={{display:"grid",textAlign:"center",color:"rgb(247, 93, 93)",backgroundColor:"white",marginBlock:"20px"}}>--- Sports ---</h1>
