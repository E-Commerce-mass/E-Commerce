...
const Womanfashion=(props)=>{
  
    const arr = []
    const filterr =(()=>{
        
  props.prodd.map((e)=>{
    if(JSON.stringify(e.categories).includes("womanfashion")){
       arr.push(e)
    ...
    return (
        <div>
 <div>
         <h1 style={{display:"grid",textAlign:"center",color:"rgb(247, 93, 93)",backgroundColor:"white",marginBlock:"20px"}}>--- Woman Fashion ---</h1>
