...
const Medecine=(props)=>{
  const data=useContext(productData)
    const arr = []
    const filterr =(()=>{
        
  data.map((e)=>{
    if(JSON.stringify(e.categories).includes("medecine")){
       arr.push(e) 
    }
})
    })
    ...
    return (
        <div>
 <div>
         <h1 style={{display:"grid",textAlign:"center",color:"rgb(247, 93, 93)",backgroundColor:"white",marginBlock:"20px"}}>--- Medecine ---</h1>
