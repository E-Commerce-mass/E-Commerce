     ...
     <div className='FoutrePosition'>
        <Stack spacing={15} direction='row'>
           ...
           <div style={{borderStyle:'inset', borderColor:'#979797'}}>
            <Button variant="contained" sx={{backgroundColor:'transparent', borderColor:'red', borderStyle:'double'}} endIcon={<SendIcon color='#3c3c3c' />}> Enter your email</Button>
            </div>
            </Stack>

            <Stack spacing={2} direction='column'>           
             <Typography variant='h6' color='#f0f0f0'>Support</Typography>
             <Typography variant='subtitle2' color='#c2c2c2'>  DH 1515, Bangladesh.</Typography>
            ...
            <Typography variant='subtitle2' color='#c2c2c2'>My Account</Typography>
            <Typography variant='subtitle2' color='#c2c2c2'>Login / Register</Typography>
            <Typography variant='subtitle2' color='#c2c2c2' >Cart</Typography>
            <Typography variant='subtitle2' color='#c2c2c2' >Wishlist</Typography>
            <Typography variant='subtitle2' color='#c2c2c2' >Shop</Typography>
            ...
            <Typography variant='subtitle2' color='#c2c2c2' >Contact</Typography>
      ...
      <Stack spacing={-8} direction='column'>
        ...
        <div className="imageWrapper">
          <img style={{ height: '119px', width: '112px', paddingLeft: '5px' }} src="https://s3-alpha-sig.figma.com/img/3893/2d5a/ccb54c528f9bcf326ca48ea29bd6d890?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=KCPclh93C-GyQ8a7wpiSxLwKm7jkZCXecAd6L2E1LZDMelVlwZNNYjPdMPndHg5rLZQijMeYuD~Vuhd9N9ZtvUq~Miuby8IhACXM70ZOcrdKHIZwilcTFlhhP2lyC8dyqFe-~cX2r0Ko4FEwuBhQ1UqCNoVDyNV4F~x0M5Yzv9zPFsRx8jhRPSbtbMiORA~7l92qTZhqhmZka~dHdXVv7j9nhIwyqIfX3upCHoMz8oqb4uE1g3D1kUWV8iFIgwwgjNFe87ikm~Bny89-2fn78Cx0CQ-JWiCq9a~mdHWEtz9RynerxzAAILC1l7~TeGrCxYL5-jdKNTOEzkN4-cwZrw__" alt="no content" />
                ...
                <Stack spacing={3} direction='row' style={{ paddingBottom: '30px' }}>
      ...
      <div className="iconWrapper">
        ...
        <div style={{ paddingTop: '45px', paddingLeft: '520px', }}>
      <Stack spacing={1} direction='row' alignItems="center">
        <Stack spacing={1} direction='row' sx={{ paddingLeft: '10px', color: '#606060' }}>
          <CopyrightIcon />
          <Typography variant='subtitle2' color='#606060'> Copyright Salah 2024. All right reserved(RBK)</Typography>
        </Stack>
      </Stack>
    </div>
